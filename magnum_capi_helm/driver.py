...
class Driver(driver.Driver):
    ...
    def _get_allowed_cidrs(self, context, cluster):
        ...
        # restricted by IP in the CONF.capi_helm.api_master_lb_cloud_allowed_cidrs, if any,
        # and the CIDR in the fixed subnet (in the case ).
    ...
    def _update_helm_release(self, context, cluster, nodegroups=None):
        ...
        values = {
            ...
            "controlPlane": {
                ...
                "machineCount": self._get_master_count( cluster ),
                "healthCheck": {
